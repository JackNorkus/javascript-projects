...
const maxNumAstronauts = 7;

let fuelLevel = 0;
let numAstronauts = maxNumAstronauts + 1;
...
//b. Use a second loop to query the user for the number of astronauts (up to a maximum of 7). Validate the entry.
  ...
  while (numAstronauts > maxNumAstronauts || numAstronauts < 0 || isNaN(numAstronauts)) {
    numAstronauts = Number(input.question("How many astronauts? "));
  }
